...
Deferred features (agentic ingestion pipeline, owned blob storage, mobile app) are documented in `deferred-features.md`. Steps 30, 31, 33, and 35–39 above have their full detailed plan in `build-history-ingestion.md`; steps 32, 34, 40, 41, and 42 (UI/core-app work, not pipeline infrastructure) are fully detailed here instead — see that file's frontmatter for why.
