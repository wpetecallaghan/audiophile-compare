...
Blind A/B comparison app for hi-fi audio systems. Next.js 15+ App Router, Supabase (Postgres + Auth), Tailwind CSS, Vercel. 19 of 20 build steps complete; 256 unit tests passing.
