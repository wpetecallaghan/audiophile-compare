...
Steps 1–31 are complete (✅ 1–16 core features; ✅ 17 E2E coverage; ✅ 18 version/commit info page; ✅ 19 about page; ✅ 20 visual polish; ✅ 21 Link component; ✅ 22 Heading/FieldLabel/TextField/FormMessage/Callout components; ✅ 23 anonymous clip playback; ✅ 24 privacy/terms pages; ✅ 25 fixed header/footer app shell; ✅ 26 delete tests/snapshots/systems; ✅ 27 handle verified-broken clip URLs; ✅ 28 concise presentation for unsupported-playback clips; ✅ 29 register with Google; ✅ 30 forum ingestion: placeholder author infrastructure; ✅ 31 forum ingestion: internal ingest API route). Step 32 (import provenance UI) and steps 33–37 (forum ingestion: scraper, extraction, commit, the import run, and rollback) are planned but not yet built — see `build-history.md` step 32 and `build-history-ingestion.md` for 33–37. The current unit test suite is 27 files / 291 tests passing, plus a separate integration suite (`npm run test:integration`, testing.md §11) that exercises the ingest route against real staging. See `testing.md` for the full inventory.
